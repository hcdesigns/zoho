...
/**
* Update Record
* Builds xml and sends updateRecord (POST) request
* @param {String} module - Zoho module
* @param {String} id - Object identificator
* @param {Object} params -  Data to send (expressed in JSON)
* @param {Function} callback -
...
* @param {Function} callback -
*/
CRM.prototype.updateRecords = function (module, params, callback) {
  params = params || {};
  ...
  this._request('POST', module + '/updateRecords', { version: 4, xmlData: xml }, callback);
};
