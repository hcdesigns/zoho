...
// Set cookie
Creator.prototype.setCookie = function(str) {
   this.cookie = str;
}
...
Creator.prototype.listFormFields = function (applicationLinkName, formLinkName, params, callback) {
  params = params || {};

  var endpoint = applicationLinkName + '/'+formLinkName+'/fields/';
